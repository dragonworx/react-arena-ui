...
export const defaultTheme: Theme = {
   ...
   borderColorLight: borderColor.darken(0.5).hex(),
   borderColor: borderColor.hex(),
   borderColorDark: borderColor.lighten(0.5).hex(),
   textColorLight: textColor.darken(0.5).hex(),
   textColor: textColor.hex(),
   textColorDark: textColor.lighten(0.5).hex(),
